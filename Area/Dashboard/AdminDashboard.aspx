<%@ Page Title="" Language="C#" MasterPageFile="~/Area/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="OnlineFoodOder.Area.Dashboard.AdminDashboard1" %>
			...
			<div class="main-page">
				...
				<div class="charts">
					<div class="col-md-4 charts-grids widget">
						...
						<h4 class="title">Restaurant graph</h4>
						<canvas id="bar" height="300" width="400"> </canvas>
					</div>
					<div class="col-md-4 charts-grids widget states-mdl">
						<%--<h4 class="title">Line Chart Example</h4>--%>
						<h4 class="title">Food graph</h4>
				...
				<div class="row">
					<div class="col-md-4 stats-info widget">
						<div class="stats-title">
							<h4 class="title">Top 20 Restaurants</h4>
						</div>
					...
					<div class="col-md-8 stats-info stats-last widget-shadow">
						<div class="stats-title">
							<h4 class="title">Top 20 Foods</h4>
						</div>
